 ...
 * Some predefined macros :-
   ...
   __FILE__         - String literal representing the name of the current source
                      file
   __LINE__         - Integer constant representing the current line number in
                      the current source file
   __STDC__         - Integer constant representing whether the implementation
                      conforms to the C standard (1 for true)
   __STDC_HOSTED__  - Integer constant representing whether the environment is
                      hosted (1 for true)
   __STDC_VERSION__ - Long integer constant in the form "yyyymmL" representing
                      the version of the C standard the compiler conforms to.
